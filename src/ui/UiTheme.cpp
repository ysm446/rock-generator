...
{
    themes_.clear();
    themes_.push_back(MakeBuiltInLithicDark());
...
bool UiThemeManager::ApplyTheme(const std::string& id)
{
    ...
    if (it == themes_.end())
    {
        it = std::ranges::find_if(themes_, [](const UiTheme& theme) { return theme.info.id == "lithic_dark"; });
    }
    if (it == themes_.end())
    {
        return false;
...
UiTheme UiThemeManager::MakeBuiltInLithicDark()
{
    UiTheme theme;
    theme.info.id = "lithic_dark";
    theme.info.name = "Lithic Dark";
    theme.base = "dark";
    theme.windowRounding = 4.0f;
    theme.frameRounding = 3.0f;
    theme.grabRounding = 3.0f;
    theme.childRounding = 4.0f;
    theme.colors = {
        {ImGuiCol_WindowBg, ImVec4(0.10f, 0.11f, 0.11f, 0.96f)},
        {ImGuiCol_ChildBg, ImVec4(0.12f, 0.13f, 0.13f, 0.88f)},
        {ImGuiCol_PopupBg, ImVec4(0.10f, 0.11f, 0.11f, 0.98f)},
        {ImGuiCol_Border, ImVec4(0.31f, 0.34f, 0.32f, 0.55f)},
        {ImGuiCol_MenuBarBg, ImVec4(0.13f, 0.14f, 0.14f, 1.0f)},
        {ImGuiCol_FrameBg, ImVec4(0.18f, 0.19f, 0.18f, 0.95f)},
        {ImGuiCol_FrameBgHovered, ImVec4(0.25f, 0.28f, 0.25f, 0.98f)},
        {ImGuiCol_FrameBgActive, ImVec4(0.30f, 0.35f, 0.31f, 1.0f)},
        {ImGuiCol_Header, ImVec4(0.24f, 0.28f, 0.25f, 0.92f)},
        {ImGuiCol_HeaderHovered, ImVec4(0.31f, 0.38f, 0.33f, 0.96f)},
        {ImGuiCol_HeaderActive, ImVec4(0.37f, 0.45f, 0.39f, 1.0f)},
        {ImGuiCol_Button, ImVec4(0.23f, 0.25f, 0.23f, 0.94f)},
        {ImGuiCol_ButtonHovered, ImVec4(0.31f, 0.37f, 0.32f, 0.98f)},
        {ImGuiCol_ButtonActive, ImVec4(0.39f, 0.47f, 0.41f, 1.0f)},
        {ImGuiCol_SliderGrab, ImVec4(0.56f, 0.67f, 0.58f, 0.95f)},
        {ImGuiCol_SliderGrabActive, ImVec4(0.68f, 0.80f, 0.70f, 1.0f)},
    };
    theme.appColors = {
